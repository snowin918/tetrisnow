...
// Draws the title screen: Local / Host / Join / Quit. Call once per frame
// while in the main-menu state; assumes an ImGui frame is already active
// (NewFrame() called, Render() not yet called) and a snowy background is
